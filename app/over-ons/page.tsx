...
export const metadata: Metadata = {
  title: "Over NCDE — Wie wij zijn",
  description: "Maak kennis met het Nationaal Collectief Duurzame Energie: onafhankelijk, transparant en betrouwbaar advies voor woningverduurzaming.",
};
