/* Subpagina Thuisbatterij - inhoud klantmockup dd 22-5-2026, vormgeving = site design-systeem */
...
export const metadata: Metadata = {
  title: "Thuisbatterij — NCDE",
  description: "Sla zonnestroom op met een thuisbatterij. NCDE berekent of een thuisbatterij voor uw situatie rendabel is.",
};
...
const systemen = [
  { tag: "Meest voorkomend", t: "Batterij met zonnepanelen", d: "Sla overtollige zonnestroom op en gebruik deze later op de dag. De meest gangbare toepassing." },
  { tag: "Bestaand systeem", t: "AC-gekoppelde batterij", d: "Aansluitbaar op de bestaande elektrische installatie. Goed toepasbaar bij bestaande zonnepanelen." },
  { tag: "Nieuw systeem", t: "DC-gekoppelde batterij", d: "Gekoppeld aan het zonnepanelensysteem vóór de omvormer. Efficiënt bij een nieuw systeem." },
  { tag: "Schaalbaar", t: "Modulaire batterij", d: "Systeem dat later uitgebreid kan worden met extra opslagcapaciteit wanneer uw energiebehoefte groeit." },
  { tag: "Dynamisch tarief", t: "Batterij met slimme sturing", d: "Laadt en ontlaadt automatisch op basis van zonneopbrengst, verbruik en dynamische energietarieven." },
  { tag: "Extra zekerheid", t: "Batterij met back-upfunctie", d: "Sommige systemen leveren bij stroomuitval beperkt stroom. Vereist speciale inrichting en installatie." },
];

const tabel = [
  { o: "U heeft zonnepanelen", w: "Meer eigen zonnestroom gebruiken in plaats van terugleveren", v: "Batterij moet passen bij uw opbrengst en verbruiksprofiel" },
  { o: "U levert veel terug", w: "Opslag beperkt teruglevering en vermijdt terugleverkosten", v: "Let op terugleververgoeding en salderingsregels" },
  { o: "Dynamisch energiecontract", w: "Slim laden bij lage tarieven en ontladen bij hoge tarieven", v: "Niet elk systeem ondersteunt dynamische sturing" },
  { o: "Meer energiezekerheid", w: "Meer controle over eigen energiestromen", v: "Back-up bij stroomuitval is niet standaard aanwezig" },
  { o: "Hoog avondverbruik", w: "Opgeslagen zonnestroom inzetten wanneer de zon niet schijnt", v: "Capaciteit moet aansluiten bij uw avondverbruik" },
];

const aandachtspunten = [
  { t: "Capaciteit en vermogen", d: "Te klein levert weinig op, te groot maakt de investering onnodig duur. Het laadvermogen bepaalt snelheid." },
  { t: "Omvormer en koppeling", d: "Niet elke bestaande omvormer is geschikt. Soms is een hybride omvormer of extra hardware nodig." },
  { t: "Veiligheid en garantie", d: "Kies betrouwbare systemen met correct geïnstalleerde beveiliging, goede garantie en lange levensduur." },
];

const saldering = [
  { tag: "Minder teruglevering", t: "Minder teruglevering", d: "Overtollige zonnestroom wordt tijdelijk opgeslagen in plaats van direct teruggeleverd aan het net." },
  { tag: "Meer eigen gebruik", t: "Meer eigen gebruik", d: "Gebruik opgeslagen zonnestroom later op de dag, zoals in de avonduren wanneer het verbruik piekt." },
  { tag: "Slimme sturing", t: "Betere sturing", d: "Met slimme software speelt het systeem in op uw verbruik, opwekking en actuele energietarieven." },
];

const stappen = [
  { n: "01", t: "Verbruiksanalyse", d: "We kijken naar uw stroomverbruik, zonnepanelen, teruglevering en momenten waarop u energie gebruikt." },
  { n: "02", t: "Kosten en terugverdientijd", d: "U krijgt inzicht in investering, maandelijkse besparing, terugverdientijd en meerdere scenario's." },
  { n: "03", t: "Passende oplossing", d: "NCDE helpt bepalen welke batterijcapaciteit en welk systeem passen bij uw woning en energieprofiel." },
];
    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/95 shadow-[var(--shadow-soft)] backdrop-blur-md">
        <div className="cx flex h-24 items-center justify-between">
          ...
          <MobileMenu active="/thuisbatterij" />
        </div>
      </header>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-wider">
                <BatteryCharging size={14} /> Energieopslag
              </span>
              <h1 className="mt-5 font-display text-4xl font-black uppercase leading-[1.05] md:text-5xl lg:text-6xl">
                Thuisbatterijen voor<br /><span className="text-amber-400">uw woning</span>
              </h1>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-white/80 md:text-lg">
                Met een thuisbatterij slaat u opgewekte zonnestroom tijdelijk op voor later gebruik. Meer grip op uw energieverbruik, minder afhankelijkheid van het net en inzicht in kosten en terugverdientijd.
              </p>
            ...
            <div className="overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl">
              <img src="/subpaginas/thuisbatterij.jpeg" alt="Thuisbatterij" className="block h-auto w-full" />
            </div>
          </div>
        </div>
      </section>

      {/* ===== WAAROM THUISBATTERIJ ===== */}
      <section className="bg-brand-50 py-14 md:py-16">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Waarom een thuisbatterij?</p>
          <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-3">
            {[
              { Icon: BatteryCharging, t: "Meer eigen gebruik van zonnestroom", d: "Sla overdag opgewekte stroom op en gebruik die 's avonds" },
              { Icon: Plug, t: "Minder afhankelijk van teruglevering", d: "Beperk teruglevering aan het net en vermijd terugleverkosten" },
              { Icon: Calculator, t: "Inzicht in kosten en terugverdientijd", d: "NCDE berekent of een batterij voor uw situatie rendabel is" },
            ].map(({ Icon, t, d }) => (
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-brand-100 bg-white p-5 text-center shadow-[var(--shadow-card)]">
              <p className="font-display text-3xl font-black text-brand-800">70%</p>
              <p className="mt-1 text-sm text-gray-700">meer eigen gebruik zonnestroom</p>
            </div>
            <div className="rounded-2xl border border-brand-100 bg-white p-5 text-center shadow-[var(--shadow-card)]">
              <p className="font-display text-3xl font-black text-brand-800">7–12jr</p>
      ...
      <section id="systemen" className="bg-white py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Batterijsystemen</p>
          ...
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            De keuze hangt af van uw zonnepanelen, energieverbruik, omvormer, beschikbare ruimte en of u voorbereiding wilt op toekomstige wijzigingen.
          </p>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          ...
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Een thuisbatterij is niet voor iedere situatie automatisch rendabel. NCDE berekent uw persoonlijke scenario op basis van verbruik, panelen en tarieven.
          </p>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
            ...
            <p className="text-sm text-amber-900">
              <strong>Let op:</strong> een thuisbatterij is niet automatisch rendabel voor iedere woning. Een goede berekening van opbrengst, verbruik, tarieven en capaciteit is noodzakelijk.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="cx">
          ...
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Een thuisbatterij moet technisch en financieel passen bij uw woning, zonnepanelen en energieprofiel.
          </p>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-brand-100 bg-brand-50 px-5 py-4">
            <Lightbulb size={18} className="mt-0.5 shrink-0 text-brand-600" />
            <p className="text-sm text-brand-900">
              <strong>Praktische tip:</strong> combineer batterijopslag altijd met een verbruiksanalyse. Dan ziet u of de batterij werkelijk past bij uw huishouden.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Zonnestroom & saldering</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Thuisbatterij, zonnepanelen en salderen
          </h2>
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Door veranderingen in de salderingsregeling wordt eigen verbruik van zonnestroom steeds belangrijker. Een thuisbatterij helpt u meer eigen stroom te benutten.
          </p>
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="cx">
          ...
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Wij brengen uw situatie persoonlijk in kaart zodat u een batterijsysteem kiest dat écht rendeert.
          </p>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl font-black uppercase leading-[1.1] md:text-4xl">
                Wilt u weten of een thuisbatterij voor u loont?
              </h2>
              <p className="mt-4 max-w-xl text-base leading-relaxed text-white/80">
                NCDE berekent uw situatie persoonlijk, met inzicht in kosten, maandelijkse besparing, teruglevering en terugverdientijd.
              </p>
