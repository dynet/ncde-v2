/* Subpagina Warmtenet & elektrisch koken - inhoud klantmockup dd 22-5-2026, vormgeving = site design-systeem */
...
export const metadata: Metadata = {
  title: "Aansluiting warmtenet & elektrisch koken — NCDE",
  description: "ISDE-subsidie voor aansluiting op een warmtenet en voor een elektrische kookvoorziening bij overstap van aardgas.",
};
...
const voorwaarden = [
  { n: "1", t: "Bestaande woning", d: "De subsidie is bedoeld voor een bestaande koopwoning waarvan u eigenaar én bewoner bent. De regeling is niet bedoeld voor reguliere nieuwbouw." },
  { n: "2", t: "Aansluiting op warmtenet", d: "U moet kunnen aantonen dat uw woning is aangesloten op een warmtenet, bijvoorbeeld met een warmteleveringsovereenkomst of verklaring van het warmtebedrijf." },
  { n: "3", t: "Overstap van gas", d: "De subsidie is gekoppeld aan het aardgasvrij maken van de woning. De aardgasmeter moet worden verwijderd of er moet een bevestiging zijn van de netbeheerder wanneer dit gebeurt." },
];

const tabel = [
  { o: "Aansluiting warmtenet", w: "Voor het aansluiten van een bestaande woning op een warmtenet als alternatief voor verwarming met aardgas.", b: "U heeft bewijs nodig van aansluiting, factuur, betaalbewijs en bevestiging van verwijdering of geplande verwijdering van de gasmeter." },
  { o: "Elektrische kookvoorziening", w: "Voor een nieuwe elektrische kookplaat of inductiekookplaat bij overstap naar elektrisch koken.", b: "De woning moet aangesloten zijn op een warmtenet. De kookvoorziening moet nieuw zijn, geïnstalleerd door een installatiebureau en binnen 24 maanden worden aangevraagd." },
];

const docs = [
  { Icon: Receipt, t: "Factuur en betaalbewijs", d: "Met datum van aansluiting of aanschaf, bedrag, datum van betaling en gegevens van leverancier of installateur." },
  { Icon: FileText, t: "Warmteleveringsovereenkomst", d: "Een kopie van de overeenkomst of verklaring waaruit blijkt dat de woning is aangesloten op een warmtenet." },
  { Icon: CheckCircle2, t: "Bevestiging netbeheerder", d: "Bewijs dat de aardgasmeter is weggehaald of een bevestiging waarop staat wanneer de gasmeter wordt weggehaald." },
  { Icon: ChefHat, t: "Bewijs elektrische kookvoorziening", d: "Factuur en betaalbewijs van de nieuwe elektrische kookplaat of inductiekookplaat." },
  { Icon: Wrench, t: "Installatiebewijs", d: "Bewijs dat de elektrische kookvoorziening is geïnstalleerd door een elektrotechnisch installatiebureau." },
  { Icon: MapPin, t: "Adresgegevens", d: "Het adres van de woning waarvoor de subsidie wordt aangevraagd en waar de aansluiting of kookvoorziening is gerealiseerd." },
];

const nietInAanmerking = [
  { Icon: Ban, t: "Geen warmtenet", d: "Een elektrische kookvoorziening komt alleen in aanmerking wanneer de woning is aangesloten op een warmtenet." },
  { Icon: FileText, t: "Geen bewijsstukken", d: "Zonder factuur, betaalbewijs, warmtecontract of bevestiging van de netbeheerder kan de aanvraag worden afgewezen." },
  { Icon: Clock, t: "Niet op tijd aangevraagd", d: "Voor ISDE geldt in veel gevallen dat u binnen 24 maanden na uitvoering of aanschaf moet aanvragen. Controleer altijd de exacte termijn." },
];

export default function WarmtenetElektrischKokenPage() {
  return (
    <>
      {/* ===== HEADER ===== */}
      <header className="sticky top-0 z-50 bg-white/95 shadow-[var(--shadow-soft)] backdrop-blur-md">
        <div className="cx flex h-24 items-center justify-between">
          ...
          <MobileMenu active="/warmtenet-elektrisch-koken" />
        </div>
      </header>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-wider">
                <Network size={14} /> Subsidie · Warmtenet & elektrisch koken
              </span>
              <h1 className="mt-5 font-display text-4xl font-black uppercase leading-[1.05] md:text-5xl lg:text-6xl">
                Aansluiting warmtenet &<br /><span className="text-amber-400">elektrisch koken</span>
              </h1>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-white/80 md:text-lg">
                ISDE (Investeringssubsidie duurzame energie en energiebesparing) geldt ook voor aansluiting op een warmtenet en voor een elektrische kookvoorziening wanneer u overstapt van aardgas naar duurzame warmte.
              </p>
              <ul className="mt-6 space-y-2 text-sm text-white/85">
                <li>✓ Specifieke situatie: overstap van gas naar warmtenet</li>
                <li>✓ Controleer vooraf de voorwaarden</li>
                <li>✓ Factuur, betaalbewijs en bevestiging verplicht</li>
              </ul>
      ...
      <section className="bg-brand-50 py-14 md:py-16">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Wat valt onder deze subsidie?</p>
          <h2 className="mt-3 max-w-3xl font-display text-2xl font-black uppercase leading-[1.15] text-brand-800 md:text-3xl">
            ISDE voor warmtenet-aansluiting en elektrisch koken
          </h2>
          <div className="mt-4 max-w-3xl space-y-4 text-base text-gray-700">
            <p>
              De ISDE kan subsidie geven voor de aansluiting van uw bestaande woning op een warmtenet. Daarnaast kunt u subsidie krijgen voor een nieuwe elektrische kookvoorziening wanneer uw woning op een warmtenet is aangesloten.
            </p>
            <p>
              Vanaf 2026 hoeft de aardgasmeter bij de aanvraag nog niet altijd direct verwijderd te zijn. Een bevestiging van de netbeheerder met de datum waarop de gasmeter wordt weggehaald kan volstaan.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="cx">
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
            ...
            <p className="text-sm text-amber-900">
              <strong>Let op:</strong> bij de aanvraag voor aansluiting op een warmtenet levert u onder andere een factuur en betaalbewijs, een kopie van de warmteleveringsovereenkomst en een bevestiging over het verwijderen van de aardgasmeter aan.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Onderdelen</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Warmtenet en elektrische kookvoorziening
          </h2>
          ...
          <div className="mt-6 rounded-2xl border border-brand-100 bg-brand-50/60 px-5 py-4">
            <p className="text-sm text-brand-900">
              <strong>Subsidie elektrische kookvoorziening:</strong> Milieu Centraal noemt voor 2026 een subsidiebedrag van <strong>€ 400</strong> voor een elektrische kookplaat bij aansluiting op een warmtenet. Controleer altijd de actuele voorwaarden bij RVO voordat u aanvraagt.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-red-600">Let op</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Wanneer komt u mogelijk niet in aanmerking?
          </h2>

          <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
            {nietInAanmerking.map(({ Icon, t, d }) => (
              <div key={t} className="rounded-2xl border border-red-100 bg-white p-6 shadow-[var(--shadow-card)]">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-red-50 text-red-700 border border-red-100">
                  <Icon size={20} />
                </div>
                <h3 className="mt-4 font-display text-lg font-black text-brand-800">{t}</h3>
                <p className="mt-2 text-sm leading-relaxed text-gray-700">{d}</p>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
            <Lightbulb size={18} className="mt-0.5 shrink-0 text-amber-600" />
            <p className="text-sm text-amber-900">
              <strong>Tip:</strong> regel de documenten vóórdat u de aanvraag indient. Vooral de bevestiging van het warmtebedrijf en de netbeheerder zijn belangrijk om vertraging of afwijzing te voorkomen.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid items-start gap-10 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-3 font-display text-3xl font-black uppercase leading-[1.1] md:text-4xl">
                  Wilt u weten of u subsidie kunt krijgen?
                </h2>
                <p className="mt-4 max-w-xl text-base leading-relaxed text-white/80">
                  NCDE helpt u met inzicht in de voorwaarden, documenten, subsidie, maandelijkse besparing en overstap naar aardgasvrij wonen.
                </p>
              ...
              <div className="space-y-3">
                {[
                  "Controle op ISDE-voorwaarden",
                  "Hulp bij juiste documenten",
                  "Inzicht in kosten en besparing",
                ].map((t) => (
      ...
      <section className="bg-gray-50 py-8">
        <div className="cx">
          <p className="rounded-xl border border-gray-200 bg-white px-5 py-4 text-xs text-gray-600">
            Informatie gebaseerd op actuele informatie van RVO en Milieu Centraal. Controleer altijd de meest recente eisen via rvo.nl. NCDE is niet verantwoordelijk voor wijzigingen in wet- of regelgeving na publicatie van deze pagina.
          </p>
        </div>
      </section>
