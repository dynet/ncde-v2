/* Subpagina Salderingsregeling - inhoud klantmockup dd 22-5-2026, vormgeving = site design-systeem */
...
export const metadata: Metadata = {
  title: "Salderingsregeling zonnepanelen — NCDE",
  description: "De salderingsregeling stopt in 2027. NCDE legt uit wat dit betekent voor uw zonnepanelen en hoe u zich kunt voorbereiden.",
};
...
const voorwaarden = [
  { n: "1", t: "Kleinverbruikaansluiting", d: "Salderen geldt voor huishoudens en kleinverbruikers met zonnepanelen die stroom terugleveren aan het net." },
  { n: "2", t: "Tot en met 2026", d: "Tot 1 januari 2027 mag teruggeleverde stroom nog worden verrekend met stroom die u afneemt van uw energieleverancier." },
  { n: "3", t: "Vanaf 2027", d: "Salderen stopt volledig. U betaalt voor afgenomen stroom en ontvangt apart een vergoeding voor teruggeleverde stroom." },
];
...
const voordelen = [
  { Icon: Zap, t: "Direct voordeel", d: "Stroom die u direct zelf gebruikt, hoeft u niet duurder van het net af te nemen. U bespaart het volledige stroomtarief per kilowattuur." },
  { Icon: TrendingDown, t: "Minder teruglevering", d: "Door slim te plannen levert u minder stroom terug en beperkt u mogelijke terugleverkosten die uw energieleverancier rekent." },
  { Icon: Wallet, t: "Betere terugverdientijd", d: "Hoe meer zonnestroom u zelf gebruikt, hoe gunstiger zonnepanelen blijven renderen na het einde van de salderingsregeling." },
];
    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/95 shadow-[var(--shadow-soft)] backdrop-blur-md">
        <div className="cx flex h-24 items-center justify-between">
          ...
          <MobileMenu active="/salderingsregeling" />
        </div>
      </header>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-wider">
                <Sun size={14} /> Zonnepanelen & regelgeving
              </span>
              ...
              <ul className="mt-6 space-y-2 text-sm text-white/85">
                ...
                <li>✓ Vanaf 2027 geen saldering meer</li>
                <li>✓ Terugleververgoeding blijft bestaan</li>
              </ul>
      ...
      <section className="bg-brand-50 py-14 md:py-16">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Wat betekent dit voor u?</p>
      ...
      <section id="voorwaarden" className="bg-white py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Belangrijkste voorwaarden</p>
          ...
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Voor wie geldt de salderingsregeling en wat zijn de spelregels tot het einde van 2026?
          </p>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4">
            ...
            <p className="text-sm text-red-900">
              <strong>Let op:</strong> energieleveranciers kunnen terugleverkosten rekenen. Kijk goed naar uw energiecontract, terugleververgoeding en voorwaarden.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Tijdlijn</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Wat verandert er?
          </h2>
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Een overzicht van de drie perioden en wat ze betekenen voor uw energierekening.
          </p>
          ...
          <div className="mt-10 overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-[var(--shadow-card)]">
            <table className="w-full min-w-[640px] text-left text-sm">
              <thead className="bg-brand-800 text-white">
                <tr>
                  <th className="px-5 py-4 font-display text-xs font-bold uppercase tracking-wider">Periode</th>
                  <th className="px-5 py-4 font-display text-xs font-bold uppercase tracking-wider">Wat gebeurt er?</th>
                  <th className="px-5 py-4 font-display text-xs font-bold uppercase tracking-wider">Gevolg voor bewoners</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {periodes.map((r) => (
                  <tr key={r.p} className="hover:bg-brand-50/50 transition-colors">
                    <td className="px-5 py-4 font-bold text-brand-800">{r.p}</td>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
            ...
            <p className="text-sm text-amber-900">
              <strong>Tip:</strong> gebruik zoveel mogelijk zonnestroom direct in huis. Denk aan wassen, drogen, vaatwasser, warmtepomp, boiler of elektrische auto op momenten dat de zon schijnt.
            </p>
          </div>
        </div>
      </section>

      {/* ===== EIGEN VERBRUIK BELANGRIJKER ===== */}
      <section className="bg-white py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Eigen verbruik wordt belangrijker</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Waarom wordt eigen verbruik belangrijker?
          </h2>
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Na 2027 betaalt u volledig voor stroom van het net. Elke kilowattuur die u zelf opwekt en direct verbruikt, bespaart u het volle nettarief.
          </p>

          <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
            {voordelen.map(({ Icon, t, d }) => (
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="cx">
          <p className="text-xs font-bold uppercase tracking-wider text-brand-600">Concrete stappen</p>
          <h2 className="mt-3 max-w-3xl font-display text-3xl font-black uppercase leading-[1.1] text-brand-800 md:text-4xl">
            Wat kunt u doen?
          </h2>
          <p className="mt-4 max-w-2xl text-base text-gray-700">
            Drie concrete stappen om uw situatie te verbeteren vóór en na 2027.
          </p>
            ...
            <div className="grid items-start gap-10 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-3 font-display text-3xl font-black uppercase leading-[1.1] md:text-4xl">
                  Wilt u weten wat salderen voor u betekent?
                </h2>
                <p className="mt-4 max-w-xl text-base leading-relaxed text-white/80">
                  NCDE berekent uw huidige situatie, teruglevering, maandelijkse besparing en terugverdientijd na 2027.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <Link href="/zonnepanelen" className="inline-flex items-center gap-2 rounded-lg border border-white/30 bg-white/10 px-6 py-3 text-sm font-bold text-white hover:bg-white/20 transition-colors">
                    Bekijk zonnepanelen
                  </Link>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {[
                  "Inzicht in besparing vóór en na 2027",
                  "Advies over eigen verbruik",
                  "Scenario met of zonder thuisbatterij",
                ].map((t) => (
